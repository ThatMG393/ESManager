 ...
 */
public class DualActionSwitchPreference extends SwitchPreferenceCompat {
     ...
     */
    public void setSwitchClickListener(DualActionSwitchPreferenceListener listener){
        this.listener = listener;
    }
    private DualActionSwitchPreferenceListener listener = null;

    /**
     * Interface gives callbacks in to both parts of the preference
     */
    public interface DualActionSwitchPreferenceListener {
        /**
    ...
    public DualActionSwitchPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public DualActionSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DualActionSwitchPreference(Context context) {
        super(context);
    }
    ...
    private SwitchCompat findSwitchWidget(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < viewGroup.getChildCount(); i++) {
                ...
                if (child instanceof SwitchCompat) return (SwitchCompat)child;
